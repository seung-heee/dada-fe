      ...
      <div className="flex flex-col h-full gap-10">
        <div className="flex-grow space-y-8">
          ...
          <div className="space-y-4 pt-4">
            <p className="text-sm text-[var(--text-sub)] ml-2">친구들에게 링크를 공유해보세요!</p>
            <div
                className="flex items-center justify-between p-4 bg-white border border-[var(--border-color)] rounded-[20px] shadow-sm active:scale-95 transition-transform cursor-pointer"
                onClick={handleCopyLink}
            >
            <span className="text-[var(--text-main)] font-medium truncate mr-4">
              {shareUrl}
            </span>
              <button className="text-[var(--primary-color)] font-bold shrink-0">
                복사
              </button>
            </div>
            <p className="text-center text-xs text-[var(--text-sub)]">
              위 박스를 누르면 링크가 바로 복사됩니다.
            </p>
          </div>
        </div>
